...
type Module = typeof import("../$phraseHanzi.js")

export type Info = {
  parents: [Parent0],
  id: "routes/phrase/$phraseHanzi"
  file: "routes/phrase/$phraseHanzi.tsx"
  path: "phrase/:phraseHanzi"
  params: {"phraseHanzi": string} & { [key: string]: string | undefined }
  module: Module
